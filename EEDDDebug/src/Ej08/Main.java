...
// este algoritmo se puede mejorar sabiendo que si un número no es divisible entre 
// 2 y su raíz cuadrada, entonces ya no será divisible por ningún otro número -> primo
//
// con esta mejora podemos ahorrar muchas vueltas del while para números grandes
        ...
        while (i <= num || primo == true) {
            ...
            {
                primo = true; // si hemos entrado aquí el número no es primo
            }
            i++;
        }
        return (primo);
